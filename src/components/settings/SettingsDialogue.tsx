...
import { ArrowLeft, ChevronLeft, Sliders, ToggleRight } from "lucide-react";
...
const SettingsDialogue = ({ isOpen, setIsOpen }: { isOpen: boolean; setIsOpen: (active: boolean) => void }) => {
